 ...
 */
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _getNestedFieldValue = __webpack_require__(5), _getNestedFieldValue2 = _interopRequireDefault(_getNestedFieldValue), _getNestedFieldValues = __webpack_require__(18), _getNestedFieldValues2 = _interopRequireDefault(_getNestedFieldValues), _index = __webpack_require__(0), _index2 = __webpack_require__(1), _index3 = __webpack_require__(2), _index4 = __webpack_require__(4);
   ...
   */
     ...
     */
                ...
                key: "indexDocumentsValue_",
                value: function(doc, uid, fieldValue) {
                    this._initialized = !0;
                    var indexStrategy = this._indexStrategy, sanitizer = this._sanitizer, searchIndex = this._searchIndex, tokenizer = this._tokenizer;
                    this._uidFieldName;
                    if (null != fieldValue && "string" != typeof fieldValue && fieldValue.toString && (fieldValue = fieldValue.toString()), 
                ...
                value: function(documents, _searchableFields) {
                    this._initialized = !0;
                    for (var uidFieldName = (this._indexStrategy, this._sanitizer, this._searchIndex, 
                    this._tokenizer, this._uidFieldName), di = 0, numDocuments = documents.length; di < numDocuments; di++) {
                        ...
                        for (var sfi = 0, numSearchableFields = _searchableFields.length; sfi < numSearchableFields; sfi++) {
                            var fieldValue, fieldValues, searchableField = _searchableFields[sfi];
                            if (searchableField instanceof Array) {
                                fieldValues = (0, _getNestedFieldValues2.default)(doc, searchableField);
                                for (var i = 0; i < fieldValues.length; i++) this.indexDocumentsValue_(doc, uid, fieldValues[i]);
                            } else fieldValue = doc[searchableField], this.indexDocumentsValue_(doc, uid, fieldValue);
                        }
                    }
                }
            }, {
 ...
 */
        function getNestedFieldValues(object, path) {
            path = path || [], object = object || {};
            // walk down the property path
            for (var values = [], value = object, i = 0; i < path.length; i++) {
                if ("[]" == path[i]) {
                    for (var j = 0; j < value.length; j++) values = values.concat(getNestedFieldValues(value[j], path.slice(i + 1, path.length)));
                    return values;
                }
                if (value = value[path[i]], null == value || void 0 == value) return [];
            }
            return [ value ];
        }
        Object.defineProperty(exports, "__esModule", {
